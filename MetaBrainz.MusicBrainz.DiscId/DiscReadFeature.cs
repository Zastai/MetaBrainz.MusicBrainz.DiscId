...
public enum DiscReadFeature {
  ...
  /// <remarks>
  /// This does not guarantee that the returned values are <em>accurate</em>; many drives (especially slimline ones) do not read
  /// ISRC values correctly.
  /// </remarks>
  TrackIsrc = 4,

  /// <summary>The ability to read CD-TEXT information.</summary>
  /// <remarks>
  /// Even when supported, relatively few discs will include this information (and even when they do, often not for all fields).
  /// </remarks>
  CdText = 8,
