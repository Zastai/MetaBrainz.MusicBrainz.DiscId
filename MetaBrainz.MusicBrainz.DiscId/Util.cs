...
internal static class Util {
  ...
  /// When <typeparamref name="T"/> is a structure with automatic layout; it should use sequential or explicit layout.
  /// </exception>
  /// <exception cref="MissingMethodException">
  /// When <typeparamref name="T"/> does not have an accessible default constructor.
  /// </exception>
